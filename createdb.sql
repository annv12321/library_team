...
create trigger no_renew_if_overdue -- Did not stop update. Add rollback and reverse inequality.
	no cascade before update on Checked_out
...
create trigger create_fine -- Did not create fine. Reverse inequality.
...
create trigger max_checkedout -- Did not stop insert. Add rollback
...
create trigger remove_book_info_when_no_copies -- Working correctly
